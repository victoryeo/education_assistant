The multiagent_mcp_server.py file is a MCP server implementation for a multi-agent education assistant system. It provides a MCP interface for interacting with the multi-agent RAG system.
