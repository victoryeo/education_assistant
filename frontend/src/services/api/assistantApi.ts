...
export const fetchTasks = async (assistantType: 'student' | 'parent'): Promise<Task[]> => {
...
export const completeTask = async (assistantType: 'student' | 'parent', taskId: string): Promise<Task> => {
